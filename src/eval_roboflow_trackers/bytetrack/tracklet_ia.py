...
class ByteTrackTrackletIa(BaseTracklet):
    def __init__(
        ...
        self.ann_id = annotation_id
        self.upd_id = annotation_id

    def __repr__(self) -> str:
        return f'Target(ann_id={self.ann_id}, upd_id={self.upd_id})'
    ...
    def _configure_noise(self) -> None:
        ...
        self.state_estimator.set_kf_covariances(
            measurement_noise=kf.measurement_noise * 0.1, process_noise=kf.process_noise * 0.01
        )
